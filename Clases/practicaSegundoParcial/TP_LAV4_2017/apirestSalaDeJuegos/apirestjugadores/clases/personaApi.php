...
class personaApi
{
	public function Alta($request, $response, $args){
        ...
        $Persona = new Persona($ArrayDeParametros['nombre'],$ArrayDeParametros['apellido'],$ArrayDeParametros['sexo'],$ArrayDeParametros['direccion'],$ArrayDeParametros['coordenadas']);
