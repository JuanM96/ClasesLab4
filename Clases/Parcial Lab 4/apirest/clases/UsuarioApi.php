...
class UsuarioApi
{
    public function AltaUsuario($request, $response, $args){
        ...
        $Usuario = new usuario($ArrayDeParametros['nombre'],$ArrayDeParametros['mail'],$ArrayDeParametros['sexo'],$ArrayDeParametros['usuario'],$ArrayDeParametros['password'],$ArrayDeParametros['foto']);
